...
# Build 018 toolchain gate. Public/reproducible release builds use the exact Go
...
if ($PSVersionTable.PSVersion -ne $ExpectedPowerShell) { throw "PowerShell toolchain mismatch: expected exactly $ExpectedPowerShell for the Build 018 release pipeline; current=$($PSVersionTable.PSVersion)" }
